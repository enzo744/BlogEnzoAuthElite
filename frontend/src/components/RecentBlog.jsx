    ...
    <div className="bg-sky-100 dark:bg-gray-800 pb-10">
      ...
      <div className="max-w-7xl mx-auto flex gap-6">
        ...
        <div className="bg-sky-50 hidden md:block dark:bg-gray-700 w-[700px] p-5 rounded-md mt-10">
          ...
          <h1 className="text-xl font-semibold ">Iscriviti alla newsletter</h1>
          <p className="text-sm text-gray-600 dark:text-gray-400">
            Ricevi gli ultimi post e gli aggiornamenti direttamente nella tua
            casella di posta.
          </p>
          ...
          <div className="mt-7">
            <h2 className="text-xl font-semibold mb-3">Blog suggeriti</h2>
