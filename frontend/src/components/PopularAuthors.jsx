...
const PopularAuthors = () => {
    ...
    const getAllUsers = async () => {
        try {
            const res = await axios.get(`https://blogenzoauthelite.onrender.com/user/all-users`)
            if (res.data.success) {
        ...
        <div>
            <div className='max-w-7xl mx-auto'>
                <div className='flex flex-col space-y-4 items-center'>
                    <h1 className='text-3xl md:text-4xl font-bold pt-10 '>Autori iscritti di recente</h1>
